...
|---|---:|---:|
| CAGR | 41.61% | 41.20% |
| 2008年以降pre-tax CAGR | 40.21% | 40.87% |
...
2008年以降CAGRは、既存の1996年開始シミュレーションを再実行せず、保存済み日次パスの2007年12月31日終値を起点に2026年4月17日までを切り出して計算しています。したがって、2008年にシグナル状態を初期化した別バックテストではありません。
